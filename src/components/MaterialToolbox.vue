  ...
  <div class="toolbox">
    ...
    <v-row>
      <v-col v-if="!selectedMaterial && !isGroup">
        ...
        ></v-select>
        <material-tool
          :materialName="chosenMaterial"
          :materialKey="materialValues[chosenMaterial]"
      ...
      <v-col v-else>
        ...
        ></v-select>
        <material-tool
          :materialName="currentMeshMaterialName"
          :materialKey="materialValues[currentMeshMaterialName]"
          :materialData="getMeshMaterial"
          ref="selectedMaterialToolbox"
...
const materialInfo = {
  ...
  9: {
    ...
    clearcoatNormalScale: Three.Vector2(1, 1),
  ...
  methods: {
    getMaterialData() {
      let jsondata = JSON.parse(
        JSON.stringify(
          this.materialData[this.materialValues[this.chosenMaterial]]
        )
      );
      return {
        datakey: this.materialValues[this.chosenMaterial],
        params: jsondata
      };
    },
    ...
    submitChanges() {
      if (this.selectedMeshMaterial) {
        this.$emit(
          'changeMesh',
          this.selectedMeshMaterial,
          this.materialValues[this.getMaterialName]
        );
      } else {
